class PostgisDsgh < Formula
  ...
  def install
    ...
    args = [
      ...
      "--with-pgconfig=#{Formula["postgresql@12.5"].opt_bin}/pg_config",
    ...
    (doc/"postgresql/extension").install Dir["stage/**/share/doc/postgresql@12.5/extension/*"]
    (share/"postgresql/extension").install Dir["stage/**/share/postgresql@12.5/extension/*"]
